...
QUnit.test("Canvas pixels from manual fills", function(assert) {
  ...
  assert.pixelNotEqual(canvas, 0, 0, 1, 1, 1, 0);
  ...
  assert.pixelNotEqual(canvas, 0, 0, 0, 0, 0, 152);
  context.clearRect(0, 0, 5, 5);
  context.fillStyle = "rgba(255, 0, 0, 0.6)";
  context.fillRect(0, 0, 5, 5);
  assert.pixelEqual(canvas, 0, 0, 255, 0, 0, 153);
  assert.pixelNotEqual(canvas, 0, 0, 255, 0, 1, 153);
  context.clearRect(0, 0, 5, 5);
  context.fillStyle = "rgba(0, 255, 0, 0.6)";
  context.fillRect(0, 0, 5, 5);
  assert.pixelEqual(canvas, 0, 0, 0, 255, 0, 153);
  assert.pixelNotEqual(canvas, 0, 0, 0, 0, 255, 153);
  context.clearRect(0, 0, 5, 5);
  context.fillStyle = "rgba(0, 0, 255, 0.6)";
  context.fillRect(0, 0, 5, 5);
  assert.pixelEqual(canvas, 0, 0, 0, 0, 255, 153);
  assert.pixelNotEqual(canvas, 0, 0, 0, 0, 254, 154);
  context.clearRect(0, 0, 5, 5);

  context.fillStyle = "rgba(0, 0, 0, 0.6)";
  context.fillRect(0, 0, 5, 5);
  assert.pixelEqual(canvas, 2, 2, 0, 0, 0, 153);
  assert.pixelNotEqual(canvas, 2, 2, 1, 1, 1, 0);
  context.clearRect(0, 0, 5, 5);
  context.fillStyle = "rgba(255, 0, 0, 0.6)";
  context.fillRect(0, 0, 5, 5);
  ...
  assert.pixelNotEqual(canvas, 4, 4, 1, 1, 1, 0);
  context.clearRect(0, 0, 5, 5);
